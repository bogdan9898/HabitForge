            ...
            OutlinedButton(
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  final name = utf8Str(nameController.text.trim());
                  final desc = utf8Str(descController.text.trim());
                  final emoji = utf8Str(emojiController.text.trim());
                  await MedalDao(AppDatabase.instance)
                      .createMedal(
                    MedalsModelCompanion(
                    ...
                    displayErrorAlert(context, onError);
                    return null;
                  });
                }
              },
